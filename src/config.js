...
module.exports = {
  ...
  // Launcher versions selectable at registration (shown as buttons)
  LAUNCHER_VERSIONS: ['Official', 'Cracked'],
  ...
  // Header used on every posted result, e.g. "1. [1.21+] Vortex Tiers"
  RESULTS_TITLE: '[1.21+] Vortex Tiers',

  // Name of the Discord "Server Booster" role — leave as-is, the bot also auto-detects
  // real boosters via member.premiumSince, this is only used as a manual fallback/override.
